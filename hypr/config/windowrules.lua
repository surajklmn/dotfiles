...
-- Privacy: protect password managers from screen sharing & streaming
hl.window_rule({ match = { class = "^(1[p|P]assword|Bitwarden|org\\.keepassxc\\.KeePassXC)$" }, no_screen_share = true, float = true })

-- Prevent screen idle/lock during fullscreen video or gaming
hl.window_rule({ match = { fullscreen = true }, idle_inhibit = "fullscreen" })
hl.window_rule({ match = { class = "^(mpv|vlc|org\\.kde\\.haruna)$" }, idle_inhibit = "focus" })
